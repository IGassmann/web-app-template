...
import {
  ...
  type ButtonProps as HeadlessButtonProperties,
...
type ButtonProperties = (
  ...
  | { color?: never; outline?: never; plain: true }
    ...
    | HeadlessButtonProperties
    | React.ComponentPropsWithoutRef<typeof Link>
  ) & { className?: ClassNameValue };

const Button = React.forwardRef(
  (
    { color, outline, plain, className, children, ...props }: ButtonProperties,
    ...
    return 'href' in props ? (
      <Link {...props} className={classes} ref={reference as React.ForwardedRef<HTMLAnchorElement>}>
        <TouchTarget>{children}</TouchTarget>
      </Link>
    ) : (
      <HeadlessButton {...props} className={twMerge(classes, 'cursor-default')} ref={reference}>
        <TouchTarget>{children}</TouchTarget>
      </HeadlessButton>
    );
  },
